...
$(() => {
  const dynamicFieldDefinitions = [
    {
      placeHolderId: "nav-link-rule-id",
      wrapperSelector: ".current-page-rules",
      fieldSelector: ".link-rule",
      addFieldSelector: ".add-current-page-rule"
    }
  ];
  ...
  dynamicFieldDefinitions.forEach((section) => {
    ...
    const autoButtonsByPosition = new AutoButtonsByPositionComponent({
      ...
      hideOnFirstSelector: `.move-up-${fieldSelectorSuffix}`,
      hideOnLastSelector: `.move-down-${fieldSelectorSuffix}`
    });
    ...
    createDynamicFields({
      ...
      moveUpFieldButtonSelector: `.move-up-${fieldSelectorSuffix}`,
      moveDownFieldButtonSelector: `.move-down-${fieldSelectorSuffix}`,
      onAddField: () => {
        createSortableList();
